...
#include <capabilities/IStartable.h>
...
bool HeadlessEngine::registerNodes()
{
    ...
    // Register built-in nodes via INodeProvider discovery
    // The node_editor_ide plugin provides INodeProvider for built-in nodes
    if (m_pluginManager) {
