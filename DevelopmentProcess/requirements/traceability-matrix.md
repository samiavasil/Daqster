...
| `REQ-SW-PL-017` | Phase Status Indicators in the Requirements Main View | ACTIVE | `REQ-SW-PL-001` | `REQ-SW-PL-002` | — | `src/plugins/requirements_manager/RequirementsParser.{h,cpp}`, `RequirementsWidget.{h,cpp}` | Qt5/Qt6 builds + test_parser (docs field) + phase-status unit tests |
