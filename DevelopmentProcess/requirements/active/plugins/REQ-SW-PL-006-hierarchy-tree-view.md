# REQ-SW-PL-006: Hierarchy Tree View
...
- [x] 1. `RequirementsTreeModel` наследява `QAbstractItemModel` или `QStandardItemModel` за организиране на дървовидна структура според полето `Родител:`.
- [x] 2. `QTreeView` визуализира йерархията с възможност за разтваряне/свиване на възли.
- [x] 3. Синхронизация между избора в дървото и детайлния панел вдясно.
