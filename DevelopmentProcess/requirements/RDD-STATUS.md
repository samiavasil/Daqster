...
| ID | Описание | Статус |
|----|----------|--------|
| INC-001 | PL-021 AC 2 е `[x]`, но texture-handle пътят е документиран като неимплементиран | Отворено |
| INC-002 | PL-022/023/024/025 REQ файловете остават ACTIVE в `active/`, докато RDD-STATUS ги води DONE | Отворено |
| INC-003 | EmbeddingData няма консуматор | Отворено |
| INC-004 | Qt5 преномерацията на image порта — **Затворено** (2026-08-26) | Затворено |
| INC-005 | Фаза 1 GPU flip е флипва вертикално (u_flipY) | Отворено |
| INC-006 | nPorts off-by-one: audio Sample port беше недостъпен на индекс 2 | **Затворено (2026-08-27)** — поправен в `d5145c2` |
