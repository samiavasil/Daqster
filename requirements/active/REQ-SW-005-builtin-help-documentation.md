...
- [x] 1. Добавен Help таб или диалог в интерфейса на плъгина.
- [x] 2. Рендиране на вграден Markdown документ с ръководство за потребителя и разработчика.
- [x] 3. Бърз достъп от главното меню на инструмента.
